...
<div class="hint">
Нажми на любой шрифт ниже — текст скопируется и его можно вставить
</div>
...
/* ===== Decor styles ===== */
function combine(m){
  return t=>t.split("").map(c=>c===" "?c:c+m).join("");
}
const decor=[
  ["Underline",combine("\u0332")],
  ["Strike",combine("\u0336")],
...
const ALL_FONTS=[...fontsEN,...fontsRU,...decor];
